...
public class GamePadSteerDrive extends PaladinsComponent {
    ...
    public GamePadSteerDrive(PaladinsOpMode opMode, Gamepad gamepad, DcMotor leftMotor, DcMotor rightMotor) {
        super(opMode);
